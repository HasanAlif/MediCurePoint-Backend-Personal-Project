...
<head>
  ...
  <title>Welcome to ${config.site_name || "DoctorPoint"}</title>
  <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>Welcome to ${config.site_name || "DoctorPoint"}!</h1>
        </div>
        <div class="body">
            <p>Hi ${name},</p>
        ...
        <div class="footer">
            <p>&copy; ${new Date().getFullYear()} ${config.site_name || "DoctorPoint"}. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
